...
if ! ufw status | grep -q "active"; then
    ...
    ufw enable || { echo "Error habilitando UFW"; exit 1; }
fi
...
# Solución error de permisos 13/05/2025 odoo15_v3_ubuntu22.04.sh
sudo chown -R odoo:$U_USER /opt
sudo chmod 775 /opt
...
Ufw:
  ...
  OpenSSH,Nginx Full y firewall habilitado e instalacion de fail2ban
